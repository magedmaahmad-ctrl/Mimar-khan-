const FooterWave = () => {
    return (
        <div className="absolute bottom-1 left-0 right-0 w-full overflow-hidden leading-none z-0 pointer-events-none">
            <div className="footer-wave-left w-[200%]">
              <svg
                className="relative block h-10 w-full md:h-12"
            ...
            <div className="footer-wave-right absolute bottom-0 left-0 w-[200%] opacity-40">
              <svg
